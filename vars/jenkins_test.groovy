                ...
                steps {
                    script {
                        ...
                        sshagent(credentials : ['ssh-key']) {
                            ...
                            sh """
                            ssh -t -t doridori@34.106.187.98 -o StrictHostKeyChecking=no "cd ./BESTIE-COMMERCE/deployment && docker compose stop && docker compose rm -f && docker compose pull && docker compose up --build -d"
                            """
