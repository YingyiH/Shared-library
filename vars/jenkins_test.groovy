                ...
                steps {
                    script {
                        ...
                        sshagent(credentials : ['ssh-key']) {
                            ...
                            // """
                            sh """
                            ssh -t -t doridori@35.235.112.242 -o StrictHostKeyChecking=no "cd ./BESTIE-Commerce-API/deployment && docker compose stop && docker compose rm -f && docker compose pull && docker compose up --build -d"
                            """
